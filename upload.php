...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $original_filename = basename($_FILES["documento"]["name"]);
    ...
    if (move_uploaded_file($_FILES["documento"]["tmp_name"], $target_file)) {
        ...
        if ($stmt->execute()) {
            echo "El archivo ". htmlspecialchars($original_filename). " ha sido subido y registrado exitosamente.";
